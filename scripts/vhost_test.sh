...
# 启动 vhost 之后 连接存储端
sudo ./scripts/rpc.py -s /var/tmp/vhost.sock bdev_nvme_attach_controller -b ump0 -t tcp -a 127.0.0.1 -f ipv4 -s 4420 -n "nqn.2016-06.io.spdk:cnode1"

sudo ./scripts/rpc.py -s /var/tmp/vhost.sock bdev_nvme_attach_controller -b ump1 -t tcp -a 127.0.0.1 -f ipv4 -s 4421 -n "nqn.2016-06.io.spdk:cnode1"

sudo ./scripts/rpc.py -s /var/tmp/vhost.sock bdev_nvme_attach_controller -b ump2 -t tcp -a 127.0.0.1 -f ipv4 -s 4422 -n "nqn.2016-06.io.spdk:cnode1"

sudo ./scripts/rpc.py -s /var/tmp/vhost.sock bdev_nvme_attach_controller -b ump3 -t tcp -a 127.0.0.1 -f ipv4 -s 4423 -n "nqn.2016-06.io.spdk:cnode1"
