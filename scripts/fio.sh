# 设备1
# sudo fio -ioengine=libaio -bs=4k -direct=1 -thread -rw=randrw -size=2048M -numjobs=2 -runtime=120 -time_based=1 -filename=/dev/nbd0 -name="BS 4KB randrw test" -iodepth=16 &
